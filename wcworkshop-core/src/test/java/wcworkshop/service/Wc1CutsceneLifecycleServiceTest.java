...
public class Wc1CutsceneLifecycleServiceTest {
  ...
  public void outputEqualsInput() {
    ...
    writerHelper.writeFile(generated, "C:/Users/martin/Programme/Wing Commander 1 and 2/WC/GAMEDAT/BRIEFING.000");
  ...
  private List<Wc1CutsceneScreen> createShotglassScreens() {
    ...
    result.add(createScreen("Welcome, Wingnut!", Wc1CutsceneForeground.SHOTGLASS, Wc1CutsceneBackground.SHOTGLASS_WINDOW, Wc1CutsceneTextColor.PEA_GREEN));

    result.add(createScreen("Now look at that.\nBeen talking the same lines for the last 23 years or so...", Wc1CutsceneForeground.SHOTGLASS,
        Wc1CutsceneBackground.SHOTGLASS_WINDOW, Wc1CutsceneTextColor.PEA_GREEN));

    result.add(createScreen("... but finally, I'm able to tell some new stories.", Wc1CutsceneForeground.SHOTGLASS, Wc1CutsceneBackground.SHOTGLASS_WINDOW,
        Wc1CutsceneTextColor.PEA_GREEN));

    result.add(createScreen("Thanks to the wingnuts over at www.wcnews.com, something is about to happen.", Wc1CutsceneForeground.SHOTGLASS,
        Wc1CutsceneBackground.SHOTGLASS_WINDOW, Wc1CutsceneTextColor.PEA_GREEN, (short) 90));

    result.add(createScreen("They have been decoding all the game files for what must have been years now...", Wc1CutsceneForeground.SHOTGLASS,
        Wc1CutsceneBackground.SHOTGLASS_WINDOW, Wc1CutsceneTextColor.PEA_GREEN, (short) 90));
    ...
    result.add(createScreen("By the way, I have never ever been sitting on one of those comfortable seats.", Wc1CutsceneForeground.SHOTGLASS,
        Wc1CutsceneBackground.SHOTGLASS_WINDOW, Wc1CutsceneTextColor.PEA_GREEN));
  ...
  private List<Wc1CutsceneScreen> createLeftScreens() {
    ...
    result.add(createScreen("By the way, does that other background make me look older?", Wc1CutsceneForeground.SHOTGLASS, Wc1CutsceneBackground.LEFT_BAR_SEAT,
        Wc1CutsceneTextColor.PEA_GREEN));

    result.add(createScreen("There must be some reason for Mr. Roberts having me stand behind that counter for so long...", Wc1CutsceneForeground.SHOTGLASS,
        Wc1CutsceneBackground.LEFT_BAR_SEAT, Wc1CutsceneTextColor.PEA_GREEN));

    result
        .add(createScreen("Hey, Colonel!\nTake a seat!", Wc1CutsceneForeground.SHOTGLASS, Wc1CutsceneBackground.LEFT_BAR_SEAT, Wc1CutsceneTextColor.PEA_GREEN));
    ...
    result.add(createScreen("Great you've finally found the time for a visit after all those years.", Wc1CutsceneForeground.SHOTGLASS,
        Wc1CutsceneBackground.LEFT_BAR_SEAT, Wc1CutsceneTextColor.PEA_GREEN));
    result.add(createScreen("Must have been years since our last briefing.", Wc1CutsceneForeground.SHOTGLASS, Wc1CutsceneBackground.LEFT_BAR_SEAT,
        Wc1CutsceneTextColor.PEA_GREEN));

    result.add(createScreen("Happy Hour, pilots! Drinks are only half the price!", Wc1CutsceneForeground.PLAYER, Wc1CutsceneBackground.SHOTGLASS_WINDOW,
        Wc1CutsceneTextColor.YELLOW));

    result.add(createScreen("You're crazy or what?", Wc1CutsceneForeground.SHOTGLASS, Wc1CutsceneBackground.LEFT_BAR_SEAT, Wc1CutsceneTextColor.PEA_GREEN));
    result.add(createScreen("Let me get back on my place!", Wc1CutsceneForeground.SHOTGLASS, Wc1CutsceneBackground.LEFT_BAR_SEAT,
        Wc1CutsceneTextColor.PEA_GREEN));
    result.add(createScreen("Happy Hour?\nYay!", Wc1CutsceneForeground.MANIAC, Wc1CutsceneBackground.RIGHT_BAR_SEAT, Wc1CutsceneTextColor.ELECTRIC_GREEN));
  ...
  private List<Wc1CutsceneScreen> createRightScreens() {
    ...
    result.add(createScreen("Hello, smarty pants!", Wc1CutsceneForeground.ANGEL, Wc1CutsceneBackground.RIGHT_BAR_SEAT, Wc1CutsceneTextColor.PEACH));
    result.add(createScreen("I hear you flew some other fighter craft all those years?", Wc1CutsceneForeground.ANGEL, Wc1CutsceneBackground.RIGHT_BAR_SEAT,
        Wc1CutsceneTextColor.PEACH));
    result.add(createScreen("Not only faster and better equipped than ours, but also with higher resolutions?", Wc1CutsceneForeground.ANGEL,
    ...
    result.add(createScreen("Even some craft from some year in the future and from different universes?", Wc1CutsceneForeground.ANGEL,
        Wc1CutsceneBackground.RIGHT_BAR_SEAT, Wc1CutsceneTextColor.PEACH));
    result.add(createScreen("But, are you also up to creating your own world?", Wc1CutsceneForeground.ANGEL, Wc1CutsceneBackground.RIGHT_BAR_SEAT,
        Wc1CutsceneTextColor.PEACH));
    result.add(createScreen("www.wcworkshop.net will be THE place to be, if you want to try.", Wc1CutsceneForeground.ANGEL,
        Wc1CutsceneBackground.RIGHT_BAR_SEAT, Wc1CutsceneTextColor.PEACH));
    result.add(createScreen("As you can see, some stuff is already working code-wise.", Wc1CutsceneForeground.ANGEL, Wc1CutsceneBackground.RIGHT_BAR_SEAT,
        Wc1CutsceneTextColor.PEACH));
    ...
    result.add(createScreen("wcworkshop does not stand for Wing Commander Workshop, after all.", Wc1CutsceneForeground.ANGEL,
        Wc1CutsceneBackground.RIGHT_BAR_SEAT, Wc1CutsceneTextColor.PEACH));
    result.add(createScreen("It's 'World Creator's Workshop'", Wc1CutsceneForeground.ANGEL, Wc1CutsceneBackground.RIGHT_BAR_SEAT, Wc1CutsceneTextColor.PEACH));
    result.add(createScreen("As Origin is not creating worlds anymore, we need to take care of that ourselves, no?", Wc1CutsceneForeground.ANGEL,
        Wc1CutsceneBackground.RIGHT_BAR_SEAT, Wc1CutsceneTextColor.PEACH));
  ...
  private Wc1CutsceneScreen createScreen(String text, Wc1CutsceneForeground foreground, Wc1CutsceneBackground background, Wc1CutsceneTextColor textColor) {
